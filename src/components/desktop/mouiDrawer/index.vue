    ...
    >
        <template v-slot:prepend>
            ...
            >
                ...
                >
                    <div
                        class="font-fredoka-one white--text text-center"
                ...
                <v-toolbar-title
                    ...
                    :class="`${theme}--text`"
                >
                    <span class="font-fredoka-one spacing-1">AgendaKU</span>
                </v-toolbar-title>
            ...
            <v-sheet class="rounded-b-lg" height="32">
                <v-scale-transition origin="center center 0">
                    ...
                    <div
                        ...
                        v-else
                    >
                        <small>monoland.soft&copy;2022</small>
                    </div>
                </v-scale-transition>
            </v-sheet>
        </template>
